...
export const getUsersBySportType = async (request, h) => {
  try {
    console.log("getUsersBySportType called with sport_type:", request.params.sport_type);
    ...
    console.log("Looking for sport_type:", capitalizedSportType);
    ...
    console.error("Error in getUsersBySportType:", error);
    ...
    return h.response({
      ...
      message: "Error retrieving subscribed users"
    }).code(500);
  }
};